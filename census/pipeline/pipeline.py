...
from census.component.model_evaluation import ModelEvaluation
from census.component.model_pusher import ModelPusher
import os,sys
import uuid
...
import pandas as pd
from census.constant import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            #Data validation
            data_validation_artifact  = self.start_dataset_validation(data_ingestion_artifact = data_ingestion_artifact)
            #Data transformation
